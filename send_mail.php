<?php require_once('config/instantiated_files.php');
       ...
       if(isset($_POST['cmd_schedule_mail'])){
            ...
            $schedule_mail_sending = schedule_mail_sending_v2($sender_emails,$recipient_emails,$email,$batch_value);
      ...
      <div id="content">
        ...
        <div class="row">
          ...
          <div class="col-md-9">
              ...
              <div class="form-group">
              <label>Batch No(e.g schdule 900 per email)</label>                                
                  <input type="number" value="900" required="" id="batch_value" name="batch_value" class="form-control form-control-sm">
              </div>
