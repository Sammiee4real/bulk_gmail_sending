            ...
            <div class="p-3">
              ...
              <form method="post" enctype="multipart/form-data" class="user" action="">
                <div class="form-group">
                    ...
                    <input type="text" required="" class="form-control form-control-sm" value="<?php echo $fname11; ?>" id="fname" name="fname" >      
                </div>
                 <div class="form-group">
                    <label>Last Name</label>                                
                    <input type="text" required="" class="form-control form-control-sm" value="<?php echo $lname11; ?>" id="lname" name="lname">      
                </div>
